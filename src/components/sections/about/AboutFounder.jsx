        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-xl font-semibold text-foreground">
              Kofi Gunubu, CPT (ASCP)
            </p>

            <p className="text-base text-accent">
              Founder &amp; Certified Phlebotomist
            </p>

            <p className="mt-5 text-base leading-relaxed text-foreground sm:text-lg">
              Kofi is a dedicated phlebotomist with over 10 years of experience
              in clinical and mobile settings. He has drawn blood for thousands
              of adult patients and understands their unique challenges. His
              gentle technique, steady hands, and warm bedside manner have
              earned him the trust of patients and healthcare providers alike.
            </p>

            <p className="mt-3 text-sm leading-relaxed text-foreground/70">
              Credentials: Master of Public Health (MPH) | CPT (ASCP) | 10+
              Years Experience | Licensed &amp; Insured | Background Checked
            </p>
