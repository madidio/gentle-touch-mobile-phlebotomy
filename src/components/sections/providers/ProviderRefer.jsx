...
const options = [
  {
    icon: CreditCard,
    title: "Hand Out Our Card",
    text: "Give the patient our business card so they can reach us directly.",
  },
  {
    icon: MessageSquare,
  ...
  {
    icon: Building2,
    title: "Dedicated Fax / Portal",
    text: "A dedicated fax or portal is available for high-volume referrers.",
  },
];
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-3">
          {options.map((o) => {
            ...
            return (
              <div
                key={o.title}
                className="rounded-xl bg-muted p-6 shadow-gt"
              >
